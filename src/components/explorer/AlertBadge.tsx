...
const AlertBadge = ({ unreadCount, onClick }: AlertBadgeProps) => (
  <button
    onClick={onClick}
    className="relative flex items-center justify-center w-8 h-8 rounded-md bg-[hsl(230,25%,13%)] border border-border text-muted-foreground hover:text-slate-300 hover:border-slate-600 transition-colors"
